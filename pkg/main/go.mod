...
require (
	...
	github.com/PuerkitoBio/goquery v1.13.0 //html parsing and manipulation
	...
	github.com/dgraph-io/ristretto/v2 v2.4.2 //memory cache
	...
	github.com/mewkiz/flac v1.0.14 //flac audio parser
	github.com/mozillazg/go-unidecode v0.2.0 //unidecode tables
	github.com/pelletier/go-toml/v2 v2.4.3 //toml config parser
	github.com/robfig/cron/v3 v3.0.1 //scheduler
	github.com/rs/zerolog v1.35.1 //logging
	github.com/stretchr/testify v1.12.1 // indirect; testing toolkit
	golang.org/x/net v0.58.0 //network utilities
	golang.org/x/oauth2 v0.36.0 //used for trakt api
	golang.org/x/sys v0.47.0
	golang.org/x/text v0.41.0 //text processing utilities
	...
	modernc.org/sqlite v1.56.0 //sqlite db driver
)
